...
function App() {
  ...
  <div class="col">
    ...
    <input type="text" class="form-control" placeholder="First name" aria-label="First name" required></input>
  </div>
  <div class="col">
    <label className="form-label">last name</label>
    <input type="text" class="form-control" placeholder="Last name" aria-label="Last name" required></input>
  </div>
</div>
      <form className="row g-3">
  <div className="col-md-6">
    <label for="inputEmail4" className="form-label">Email</label>
    <input type="email" className="form-control" placeholder="votre e-mail" id="inputEmail4" required></input>
  </div>
  <div className="col-md-6">
    <label for="inputPassword4" className="form-label">Password</label>
    <input type="password" className="form-control" id="inputPassword4" required></input>
  </div>
  ...
  <div className="col-md-2">
    ...
    <input type="text" className="form-control" id="inputZip" required></input>
  </div>
  <div className="col-12">
